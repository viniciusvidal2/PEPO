...
//                    v = (v < 0) ? 0 : v;
    ...
    /// Encontrar indice do ponto na esfera correspondente a essas coordenadas
    /// A partir do indice, ja temos nesse ponto alocado nas normais as coordenadas do pixel que o ponto corresponde na imagem final 360
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//        int contador = 0;
        ...
        for (int i = 13; i < 30; i++)
	{
                ROS_INFO("Projetando imagem %d de %d ...\n", i+1, nomes_imagens.size());
		...
		*/
		...
		pCenter = T * p;
                ...
                ROS_INFO("Pintando a imagem 360 a partir dessa vista ...");
                doTheThing(step_deg, p2.block<3, 1>(0, 0), p4.block<3, 1>(0, 0), p5.block<3, 1>(0, 0), image, im360);
                ROS_INFO("Indo para proxima vista.");
...
//		{
//                        // Para cada coordenada ja calculada do plano
//		}
